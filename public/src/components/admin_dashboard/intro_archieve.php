...
<table class="table table-bordered">
  ...
  <tr>
    <td><img src="../../../main/images/intro_section/archive/<?php echo $row['file_name']; ?>" width="100"></td>
    <td><?php echo htmlspecialchars($row['original_name']); ?></td>
    <td><?php echo $row['created_at']; ?></td>
    <td>
      <form method="POST" action="../../backend/admin_dashboard/recover_intro.php">
...
function restoreDownload(id, key) {
    if (confirm("Are you sure you want to restore this file?")) {
        $.post("../../backend/admin_dashboard/recover_intro.php", { id: id, key_name: key }, function(response) {
