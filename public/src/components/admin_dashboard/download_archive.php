...
$key = 'person1'; // you can make this dynamic if needed
...
<table border="1" cellpadding="10">
    ...
    <tr>
        <td><img src="/philtrans/philtransweb/public/main/images/download_section/archive/<?php echo htmlspecialchars($row['file_name']); ?>" width="100">
</td>
